...
export const partition = (array, f) => array.reduce((res, cur) => {
...
export const isExpiration = (begin, duration) => begin + duration * 1000 > Date.now()

export const override = (obj, method, f) => {
  const prevFunc = obj[method]
  obj[method] = function(...args) {
    f((...args) => prevFunc.call(this, ...args), ...args)
  }
}
