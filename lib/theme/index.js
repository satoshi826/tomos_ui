...
export const style = {
  ...
  keyframe(selector, obj, option) {
    this.set(`${selector}&keyframe`,
      oReduce(obj, (str, [k, v]) => str += `${k}{${toCss(v)}}`, `@keyframes ${selector} {`) + '}', 
      option
    )
  },
